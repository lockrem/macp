...
function registerIntroductionRoutes(app) {
    ...
    app.get('/api/introductions', async (req) => {
    ...
    app.get('/api/introductions/:agentId', async (req) => {
        const userId = req.user?.userId || 'demo-user';
    ...
    app.post('/api/introductions/:agentId/start', async (req) => {
        const userId = req.user?.userId || 'demo-user';
        const { agentId } = req.params;
    ...
    app.post('/api/introductions/:agentId/skip', async (req) => {
        const userId = req.user?.userId || 'demo-user';
        const { agentId } = req.params;
    ...
    app.post('/api/introductions/:agentId/reset', async (req) => {
        const userId = req.user?.userId || 'demo-user';
        const { agentId } = req.params;
