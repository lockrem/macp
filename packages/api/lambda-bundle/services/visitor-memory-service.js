...
exports.getVisitorMemory = getVisitorMemory;
exports.saveVisitorMemory = saveVisitorMemory;
exports.updateVisitorMemoryFromSession = updateVisitorMemoryFromSession;
exports.formatVisitorMemoryAsContext = formatVisitorMemoryAsContext;
exports.distributeMemoriesToAgents = distributeMemoriesToAgents;
 ...
 */
async function getVisitorMemory(agentId, visitorId) {
 ...
 */
async function saveVisitorMemory(memory) {
 ...
 */
async function updateVisitorMemoryFromSession(agentId, visitorId, sessionId, extractedMemories, extractedPreferences, visitorName) {
 ...
 */
function formatVisitorMemoryAsContext(memory) {
 ...
 */
async function distributeMemoriesToAgents(facts, userAgents, apiKey) {
    ...
    const agentProfiles = userAgents.map(a => `- ${a.name} (ID: ${a.id}): ${a.description || a.intents.join(', ')}. Tracks: ${a.memoryCategories?.join(', ') || a.intents.join(', ')}`).join('\n');
...
//# sourceMappingURL=visitor-memory-service.js.map