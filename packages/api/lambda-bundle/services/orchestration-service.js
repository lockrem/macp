...
exports.analyzeAndRoute = analyzeAndRoute;
exports.analyzeForMultiAgent = analyzeForMultiAgent;
exports.shouldHandoff = shouldHandoff;
exports.getDefaultAgentConfigs = getDefaultAgentConfigs;
 ...
 */
async function analyzeAndRoute(userId, message, conversationHistory, availableAgents, apiKey) {
 ...
 */
async function analyzeForMultiAgent(userId, message, conversationHistory, availableAgents, apiKey) {
    const key = apiKey || process.env.ANTHROPIC_API_KEY;
...
Analyze which agents should contribute to this response.`;
        ...
        const supportingAgents = analysis.supporting
            .map(s => {
 ...
 */
function keywordBasedMultiAgent(message, agents) {
 ...
 */
function keywordBasedRouting(message, agents) {
    const lower = message.toLowerCase();
 ...
 */
function findBestAgent(intent, agents) {
    // Direct intent match
 ...
 */
function shouldHandoff(currentAgentId, newRouting) {
