 ...
 */
export declare function getUserIdOrNull(request: FastifyRequest): string | null;
/**
 * Require authentication and return userId, or send 401 response.
 * Returns userId if authenticated, null if 401 was sent.
 */
export declare function requireUserId(request: FastifyRequest, reply: FastifyReply): string | null;
export {};
